...
public class AcceptedChallengeModel implements Serializable {
    ...
    public List<My_challenge> getAcceptedChallengeList() {
    ...
    public class My_challenge implements Serializable{
        ...
        @SerializedName("challenge_created_by")
        String challenge_created_by;
        @SerializedName("date")
        String date;
        ...
        public String getChallenge_created_by() {
            return challenge_created_by;
        }
